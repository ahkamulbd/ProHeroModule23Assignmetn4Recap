...
function publicBusFare(passengerNumber) {
    ...
    const restPassengerAfterBus = passengerNumber % busCapacity;
    const restPassengerAfterMicroBus = restPassengerAfterBus % microBusCapacity;

    const publicBusFareCost = restPassengerAfterMicroBus * publicBusTicketPrice;

    return publicBusFareCost;
}

const moneyForPublicBusFair = publicBusFare(365);
console.log(moneyForPublicBusFair);